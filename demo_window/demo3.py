...
signup_button.pack()
l=tk.Label(window,text="passanger",bg="white",fg="black",font=10,height=2,width=10).pack(padx=400,side=tk.LEFT)
Label(text="").pack()
l1=tk.Label(window,text="passanger",bg="white",fg="black",font=10,height=2,width=10).pack(padx=100,side=tk.LEFT)
#l2=tk.Label(window,text="passanger",bg="white",fg="black",font=10,height=2,width=10).pack(padx=200,side=tk.LEFT)
window.mainloop()
